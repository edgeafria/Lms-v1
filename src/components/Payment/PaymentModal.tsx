            ...
            <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
              <img
                ...
                onError={(e) => {
                  ...
                  ).src = `https://placehold.co/150x100?text=Course`;
                }}
              />
              <div className="flex-1">
                <h4 className="font-body font-semibold text-gray-900 line-clamp-1">
                  {course.title}
                </h4>
            ...
            >
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h5 className="font-body font-semibold text-blue-900">
                      Secure Payment
                    </h5>
